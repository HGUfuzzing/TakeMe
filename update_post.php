            ...
            <div id="all-element">
                <div class="col">
                    <div id="col1">
                        ...
                        <div class="input-block">
                            <label class="post-label">URL 키워드</label>
                    ...
                    <div id = "col2" class="input-block">
                        <?php 
                        echo '<img class="show-poster" style="width:200px;height:200px;background-color:white" src="data:image/jpeg;base64, '.base64_encode( $image).'" alt="no-image"/>';
                        ?>
                    </div>
                </div>
